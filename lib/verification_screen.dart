...
class VerificationScreen extends StatefulWidget {
  ...
  const VerificationScreen({super.key, required this.email, required this.verificationCode});
...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  void initState() {
    ...
    print('Initial email: ${widget.email}, Initial code: $currentVerificationCode');
  }
                          ...
                          onPressed: () async {
                            try {
                              ...
                              setState(() {
                                ...
                                _errorMessage = null;
                                _successMessage = 'New code sent successfully! Check your email (including spam).';
                                for (var controller in _codeControllers) {
                                  controller.clear();
                                }
                              });
                              ...
                              setState(() {
                                _errorMessage = 'Failed to resend code. Details: $e';
